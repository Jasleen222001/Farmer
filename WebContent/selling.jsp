...
<%@page import="com.auribises.model.User"%>
<%@page import="com.auribises.model.Selling"%>
...
<div class="w3-container w3-center w3-teal" style="width:50%" style="height:50%">
      ...
      selling.userId = user._id;
      selling.selling = Double.parseDouble(request.getParameter("txtSp"));
	%>
	</div>
...
<%
DB db = new DB();
db.logSelling(selling);
	%>
		<h2><p>Your Selling price has been Recorded Successfully: <%= selling.selling %></p></h2>
    </div>
    <center>
	</body>
</html>